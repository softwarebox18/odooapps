...
class ResPartnerInheritNameSearch(models.Model):
...
class many2one_name_search_config(models.Model):

    _name = 'many2one.name.search.config'
    _description = 'Name Search Config'
    _rec_name = 'model_id'
